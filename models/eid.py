...
EIDEvent = [
    ...
    {'name':'pathogens', 'type':'model'},
    {'name':'location'},
    {'name':'host'},
    {'name':'disease'},
    {'name':'start_date', 'type': 'date'},
    {'name':'end_date', 'type': 'date'},
    {'name':'host_age', 'type': 'select', 'options':host_age},
    {'name':'host_use', 'type': 'select', 'options':host_use},
    {'name':'transition_model', 'type': 'select', 'options': transition_model},
    {'name':'zoonotic_type', 'type': 'select', 'options': zoonotic_type},
    {'name':'number_infected'},
    {'name':'prevalence'},
    {'name':'duration', 'type': 'units', 'units': time_period},
    {'name':'symptoms_reported'},
    {'name':'host_sex', 'type': 'select', 'options':host_sex},
    {'name':'sample_type', 'type': 'select', 'options': sample_type},
    {'name':'driver','type': 'select', 'options': driver},
    {'name':'domestication_status', 'type': 'select', 'options': domestication_status},
    {'name':'number_deaths'},
    {'name':'contact'},
    {'name':'notes'},
